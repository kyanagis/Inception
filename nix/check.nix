...
pkgs.testers.runNixOSTest {
  ...
  testScript = ''
    ...
    machine.succeed("for cmd in jq python3 ip shellcheck git make curl openssl nmap tcpdump gdb valgrind gh inception-evaluate inception-audit inception-diagnostics; do command -v \"$cmd\"; done")
